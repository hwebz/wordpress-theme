<?php
	function customize_register($wp_customize) {
		...
		$wp_customize->add_setting('banner_text', array(
			'default'        => _x('Welcome to the Wordpress Business Theme. This theme uses the Twitter Bootstrap 3 framework and can be customized to your own liking', 'business'),
			'type'           => 'theme_mod'
		));
		...
		$wp_customize->add_setting('banner_image', array(
			'default'        => get_bloginfo('template_directory').'/images/pic1.jpg',
			'type'           => 'theme_mod'
		));
		...
		$wp_customize->add_setting('box3_icon', array(
			'default'        => _x('blackboard', 'business'),
			'type'           => 'theme_mod'
		));
